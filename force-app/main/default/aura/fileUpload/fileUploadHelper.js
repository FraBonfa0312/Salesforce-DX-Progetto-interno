({
    ...
    uploadChunk : function(component, file, fileContents, fromPos, toPos, attachId) {
        ...
        action.setCallback(this, function(a) {
            ...
            document.getElementById('fileName').href ='/one/one.app#/sObject/' + attachId+ '/rlName/AttachedContentDocuments/view';
            fromPos = toPos;
        ...
        uploadFile:function(component,event){
            ...
            var fileBtn = component.find("saveBtn");
            var actual = fileBtn.getLocalId();
