({
                   ...
                   component.find("calloutUtil").runCallOut(
                       ...
                       function(calloutResponse,calloutError) { 
                          ...
                          if (calloutResponse) {
                              ...
                              console.error('performCallout: triggering callout error notification',JSON.stringify(mergeError));
    ...
    updateObject : function(component,responseJson) {
        ...
        var fieldsJSON = component.get("v.fieldsJSON");
    ...
    updateList : function(component,responseJson,helper) {
        ...
        var listResults;
        var listField = component.get("v.listField");
